...
// ========== Кандидаты ==========
export type CandidateStatus = 'NEW' | 'TEST' | 'INTERVIEW' | 'OFFER' | 'REJECTED' | 'HIRED';
...
// ========== Интервью ==========
export type InterviewResult = 'AWAIT_INTERVIEW' | 'INTERVIEW_PASSED' | 'INTERVIEW_FAILED';
...
// ========== Офферы ==========
export type OfferStatus = 'PENDING' | 'APPROVED_MNG' | 'REJECTED_MNG' | 'APPROVED_CND' | 'REJECTED_CNF';
