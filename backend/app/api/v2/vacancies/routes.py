...
@router.get(
    "/{vacancy_id}", response_model=VacancyResponse, status_code=status.HTTP_200_OK
)
...
@router.get("", response_model=VacancyFilterResponse, status_code=status.HTTP_200_OK)
